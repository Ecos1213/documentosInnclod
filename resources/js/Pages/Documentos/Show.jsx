                    ...
                    <div className="overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                            ...
                            <div className='mt-4 p-4 border-solid border-2 border-indigo-500/50 rounded-lg'>
                                ...
                                <p className='font-medium text-gray-900 whitespace-nowrap dark:text-white'>{documento.doc_nombre}</p>
                            </div>
                            ...
                            <div className='mt-4 p-4 border-solid border-2 border-indigo-500/50 rounded-lg'>
                                ...
                                <p className='font-medium text-gray-900 whitespace-nowrap dark:text-white'>{`${documento.tiptipodoc.tip_prefijo}-${documento.proproceso.pro_prefijo}-${documento.doc_codigo}`}</p>
                            </div>
                            <div className='mt-4 p-4 border-solid border-2 border-indigo-500/50 rounded-lg'>
                                <h2 className='font-black'>Nombre de proceso documento</h2>
                                <p className='font-medium text-gray-900 whitespace-nowrap dark:text-white'>{documento.proproceso.pro_nombre}</p>
                            </div>

                            <div className='mt-4 p-4 border-solid border-2 border-indigo-500/50 rounded-lg'>
                                <h2 className='font-black'>Tipo de documento</h2>
                                <p className='font-medium text-gray-900 whitespace-nowrap dark:text-white'>{documento.tiptipodoc.tip_nombre}</p>
                            </div>

                            <div className='mt-4 p-4 border-solid border-2 border-indigo-500/50 rounded-lg'>
                                <h2 className='font-black'>Prefijo de proceso documento</h2>
                                <p className='font-medium text-gray-900 whitespace-nowrap dark:text-white'>{documento.proproceso.pro_prefijo}</p>
                            </div>
                            ...
                            <div className='mt-4 p-4 border-solid border-2 border-indigo-500/50 rounded-lg'>
                                ...
                                <p className='font-medium text-gray-900 whitespace-nowrap dark:text-white'>{documento.tiptipodoc.tip_prefijo}</p>
                            </div>
                        </div>
                    </div>
                </div>
