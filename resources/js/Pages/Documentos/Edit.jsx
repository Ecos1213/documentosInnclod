...
export default function Edit({ auth, procesos, tipodocumento, documento }) {

    console.log(documento);

    const {data, setData, put, processing, errors, reset} = useForm({
        doc_nombre: documento.doc_nombre,
        doc_id_proceso: documento.id_proceso,
    ...
    const [process, setProcess] = useState(procesos);
    const [typeDoc, setTypeDoc] = useState(tipodocumento);

    const handleOnSubmit = (e) => {
        e.preventDefault();
        put(route('documentos.edit'));
    }
